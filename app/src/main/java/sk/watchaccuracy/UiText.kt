...
fun uiText(language: String) = if (language == "en") UiText(
    ...
    continueCamera="Continue to camera", cameraPermission="Camera permission is required", cameraGuide="Place the entire dial inside the marked shape",
    ...
    continueCamera="Pokračovať k fotoaparátu", cameraPermission="Fotoaparát potrebuje povolenie", cameraGuide="Umiestnite celý ciferník do vyznačeného tvaru",
